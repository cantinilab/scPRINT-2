...
export NTV3_BATCH_SIZE=16

SPECIES=(
  homo_sapiens mus_musculus arabidopsis_thaliana bos_taurus
  caenorhabditis_elegans callithrix_jacchus danio_rerio drosophila_melanogaster
  gallus_gallus heterocephalus_glaber_male macaca_mulatta oryctolagus_cuniculus
  ovis_aries pan_troglodytes sus_scrofa zea_mays
)
